...
public class CConfigServicesManager extends CAbstractConfigLoader {
	...
	public String strRegisterServicesDir;
	...
	public String strPassword; //Register password
	public int intFrequencyCheckRemove;
	public int intRemoveRegisteredTimeout;
	...
	public CConfigServicesManager( String strRunningPath ) {
		...
		strPassword = ConstantsServicesManager._Register_Password;
		intFrequencyCheckRemove = ConstantsServicesManager._Frequency_Check_Remove;
		intRemoveRegisteredTimeout = ConstantsServicesManager._Remove_Registered_Timeout;
		
		strTempDir = strRunningPath + ConstantsCommonClasses._Temp_Dir; //"Temp/";
		strRegisterServicesDir = strRunningPath + ConstantsServicesManager._Register_Services_Dir; //"DBServices/"; 
		            ...
		            if ( NodeAttribute != null ) {
						...
						if ( NodeAttribute.getNodeName().equals( ConstantsCommonConfigXMLTags._Password ) ) {
							...
							if ( NodeAttribute.getNodeValue().isEmpty() == false ) {
								...
								this.strPassword = NodeAttribute.getNodeValue();
								Logger.logMessage( "1", Lang.translate( "Runtime config value [%s] changed to: [%s]", "strPassword", this.strPassword ) );

							}
					        else {
					        	
						        Logger.logWarning( "-1", Lang.translate( "The [%s] attribute cannot empty string, using the default value [%s]", ConstantsCommonConfigXMLTags._Password, this.strPassword ) );
							...
							this.strRegisterServicesDir = NodeAttribute.getNodeValue();
		
					        if ( this.strRegisterServicesDir != null && this.strRegisterServicesDir.isEmpty() == false && new File( this.strRegisterServicesDir ).isAbsolute() == false ) {

					        	this.strRegisterServicesDir = this.strRunningPath + this.strRegisterServicesDir;
						        	
						    }

					        Logger.logMessage( "1", Lang.translate( "Runtime config value [%s] changed to: [%s]", "strDBServicesDir", this.strRegisterServicesDir ) );
				        
					        if ( Utilities.checkDir( this.strRegisterServicesDir, Logger, Lang ) == false ) {
						...
						else if ( NodeAttribute.getNodeName().equals( ConstantsConfigXMLTags._Frequency_Check_Remove ) ) {

							int intTempFrequencyCheckRemove = net.maindataservices.Utilities.strToInteger( NodeAttribute.getNodeValue().trim(), Logger );
							
							if ( intTempFrequencyCheckRemove > 0 ) {
								
								this.intFrequencyCheckRemove = intTempFrequencyCheckRemove;
								
							}
							else {
								
						        Logger.logWarning( "-1", Lang.translate( "The [%s] attribute value [%s] is invalid, using the default value [%s]", ConstantsConfigXMLTags._Frequency_Check_Remove, Integer.toString( this.intFrequencyCheckRemove ) ) );
								
							}
							
						}
						else if ( NodeAttribute.getNodeName().equals( ConstantsConfigXMLTags._Remove_Registered_Timeout ) ) {

							int intTempRemoveRegisteredTimeout = net.maindataservices.Utilities.strToInteger( NodeAttribute.getNodeValue().trim(), Logger );
							
							if ( intTempRemoveRegisteredTimeout > 0 && this.intFrequencyCheckRemove > intTempRemoveRegisteredTimeout ) {

								this.intRemoveRegisteredTimeout = intTempRemoveRegisteredTimeout;
								
							}
							else {
								
						        Logger.logWarning( "-1", Lang.translate( "The [%s] attribute value [%s] is invalid, using the default value [%s]", ConstantsConfigXMLTags._Remove_Registered_Timeout, Integer.toString( this.intRemoveRegisteredTimeout ) ) );
		            	...
		            	if ( strAttributesOrder[ intAttributesIndex ].equals( ConstantsCommonConfigXMLTags._Password ) ) {
					        ...
					        Logger.logWarning( "-1", Lang.translate( "The [%s] attribute not found, using the default value [%s]", ConstantsConfigXMLTags._RegisterServices_Dir, this.strRegisterServicesDir ) );
						...
						else if ( strAttributesOrder[ intAttributesIndex ].equals( ConstantsConfigXMLTags._Frequency_Check_Remove ) ) {

					        Logger.logWarning( "-1", Lang.translate( "The [%s] attribute not found, using the default value [%s]", ConstantsConfigXMLTags._Frequency_Check_Remove, Integer.toString( this.intFrequencyCheckRemove ) ) );
							
						}
						else if ( strAttributesOrder[ intAttributesIndex ].equals( ConstantsConfigXMLTags._Remove_Registered_Timeout ) ) {

					        Logger.logWarning( "-1", Lang.translate( "The [%s] attribute not found, using the default value [%s]", ConstantsConfigXMLTags._Remove_Registered_Timeout, Integer.toString( this.intRemoveRegisteredTimeout ) ) );
